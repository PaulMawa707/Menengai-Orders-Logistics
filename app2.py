...
def read_pdf_to_df(pdf_file):
    ...
    required_columns = [
        "REP", "CUSTOMER ID", "CUSTOMER NAME", "LOCATION", "COORDINATES",
    ...
    df_cleaned[['LAT', 'LONG']] = df_cleaned['COORDINATES'].apply(lambda x: pd.Series(extract_coordinates(x)))
    ...
    for idx, row in df_cleaned.iterrows():
        ...
        order = {
            ...
            "p": {
                ...
                "v": 50, "w": float(row['TONNAGE']) * 1000 if row['TONNAGE'].replace('.', '', 1).isdigit() else 0, "c": row['AMOUNT'], "ut": 1800,
            ...
            "trt": 600, "r": 100, "y": latitude, "x": longitude,
            "ej": {}, "tz": 3,
