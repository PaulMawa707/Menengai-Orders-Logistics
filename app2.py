...
def send_orders_and_create_route(token, resource_id, unit_id, vehicle_name, df_grouped, tf, tt):
    try:
        ...
        # Add notification settings for route creation
        ...
        notification_params = json.loads(notification_payload["params"])
        notification_params["ordersNotification"]["webhookParams"] = webhook_params
        notification_payload["params"] = json.dumps(notification_params)
